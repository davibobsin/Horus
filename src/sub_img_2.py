...
def article(img_name, diff='sub.png'):
    ...
    dilation = cv2.dilate(th3,kernel,iterations = 15)
    ...
    cv2.imwrite('../img/find_blank/article_5_1.png',closing)

    im_th = cv2.adaptiveThreshold(closing, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY_INV, 5, 4)
    cv2.imwrite('../img/find_blank/article_5_2.png',im_th)
